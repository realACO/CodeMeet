...
function SessionPage() {
  ...
  //auto join session if user is not aleady a participant or host
  useEffect(() => {
  ...
  //redirect the participants when session ends
  useEffect(() => {
  ...
  const handleEndSession = () => {
    if (confirm("Are you sure you want to end the session?")) {
      //this will navigate the host to the dashboard
              ...
              {isInitializingCall ? (
                <div className="flex items-center justify-center h-full">
                  <div className="text-center">
                    <Loader2Icon className="w-10 h-12 mx-auto animate-spin text-primary mb-4" />
